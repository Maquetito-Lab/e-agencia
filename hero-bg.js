...
(() => {
  ...
  const frag = `
    ...
    void main(){
      ...
      // paleta Canva
      vec3 pink   = vec3(0.922, 0.643, 0.804);
      vec3 lime   = vec3(0.827, 0.894, 0.298);
      vec3 olive  = vec3(0.290, 0.416, 0.173);
      vec3 fucsia = vec3(0.773, 0.400, 0.663);
      vec3 mauve  = vec3(0.725, 0.541, 0.659);
      ...
      col = mix(col, pink, clamp(exp(-dot(dp, dp) * 3.2), 0.0, 1.0));
